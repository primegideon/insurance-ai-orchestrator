...
def _build_audit_pdf(
    ...
    story.append(Paragraph(
        f"Generated by Trace: Enterprise AI Underwriter &nbsp;·&nbsp; IBM watsonx.ai (IBM Granite 4) "
...
def show_dashboard() -> None:
    ...
    # ── Connector ─────────────────────────────────────────────────────────────
    st.markdown(
        '<div class="connector-bar">🤖 IBM Granite 4 connected the dots</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        f'<span class="ai-badge">IBM watsonx · IBM Granite 4</span>'
